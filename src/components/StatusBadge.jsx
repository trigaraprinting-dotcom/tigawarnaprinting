...
const STATUS_CONFIG = {
  awaiting_dp:  { label: 'Menunggu DP',   bg: 'bg-orange-50',  text: 'text-orange-700', dot: 'bg-orange-500' },
  ...
  ready:        { label: 'Siap Diambil',  bg: 'bg-teal-50',    text: 'text-teal-700',   dot: 'bg-teal-500'   },
